...
// Wait for both DOM and app object to be ready
function _waitForApp(callback) {
    if (typeof app !== 'undefined' && typeof VMB !== 'undefined') {
        callback();
    } else {
        setTimeout(() => _waitForApp(callback), 50);
    }
}
